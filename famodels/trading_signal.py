...
class TradingSignal(BaseModel):
    ...
    """
    provider_id: str = Field(..., description="Your ID as a provider, who emitted the signal.")
    ...
    date_of_creation: datetime = Field(default_factory=datetime.now, description="The UTC datetime when the signal was created by the signal supplier.")
